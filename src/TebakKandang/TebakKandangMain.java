...
public class TebakKandangMain {
    //class kandang
    static Kandang kandang = new Kandang();
    static KandangKambing kambing = new KandangKambing();
    static KandangBebek bebek = new KandangBebek();
    static KandangZebra zebra = new KandangZebra();
